...
def test_single_case(net, op_net,image, stride_xy, stride_z, patch_size, num_classes=1,
                     post_process=False):
    ...
    for x in range(0, sx):
        ...
        for y in range(0, sy):
            ...
            for z in range(0, sz):
                ...
                or_feature, _,mm,_= net(test_patch,mm=True)
                y1 = op_net(or_feature, mm)
...
if __name__ == '__main__':
    ...
    # print(ckpt)
    # for i in ckpt:
    # ckpt = [i for i in ckpt if ".pth" in str(i)]
    ckpt='model10.8839380247643872_2250.pth'
